          ...
          <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a href="index.html"><i class="las la-battery-three-quarters"></i><span class="menu-title" data-i18n="nav.dash.main">Appointments</span></a>
              <ul class="menu-content">
                ...
                <li class="{{ Route::currentRouteName() == "add_appointment_doc" ? 'active':'' }}" ><a class="menu-item"  href="{{ route("add_appointment_doc") }}" data-i18n="nav.dash.crypto">

                   <?php
                    if (App\Models\AppointmentAvailable::where('doctor_id',Auth::user()->doctor->id)->exists()){
                        ?>
                      edit appointment
                     <?php
                    }
