    ...
    <div class="content-wrapper">
      ...
      <div class="main-menu menu-static menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="main-menu-content">
          <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a href="index.html"><i class="las la-battery-three-quarters"></i><span class="menu-title" data-i18n="nav.dash.main">Sensors</span></a>
              <ul class="menu-content">
                <li class="{{ Route::currentRouteName() == "show_sensor" ? 'active':'' }}" ><a class="menu-item"  href="{{ route("show_sensor") }}" data-i18n="nav.dash.crypto">show sensors</a>
                </li>
                <li class="{{ Route::currentRouteName() == "add_sensor" ? 'active':'' }}"><a class="menu-item" href="{{ route("add_sensor") }}" data-i18n="nav.dash.ecommerce">Add sensor</a>
                </li>
              </ul>
            </li>
          ...
          <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a href="index.html"><i class="las la-battery-three-quarters"></i><span class="menu-title" data-i18n="nav.dash.main">Doctors</span></a>
              <ul class="menu-content">
                <li class="{{ Route::currentRouteName() == "show_sensor" ? 'active':'' }}" ><a class="menu-item"  href="{{ route("show_sensor") }}" data-i18n="nav.dash.crypto">show sensors</a>
                </li>
                <li class="{{ Route::currentRouteName() == "add_sensor" ? 'active':'' }}"><a class="menu-item" href="{{ route("add_sensor") }}" data-i18n="nav.dash.ecommerce">Add sensor</a>
  ...
  <footer class="footer footer-static footer-light navbar-border">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block">Copyright &copy; 2022 <a class="text-bold-800 grey darken-2" href="https://themeforest.net/user/pixinvent/portfolio?ref=pixinvent"
        target="_blank">SRC </a> , All rights reserved. </span>
