          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-content collapse show">
                <div class="card-body">
                  <form class="form" wire:submit.prevent="edit_sensor">
                    <div class="form-body">
                        ...
                        <div class="col-md-6">
                                  ...
                                  <div class="card-body">
                                    <fieldset class="form-group">
                                      <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="inputGroupFile01" wire:model="new_sensor_image">
                          ...
                          <div class="col-md-6">
                            <div class="card">
                                <div class="card-block">
                                  <div class="card-body">
                                    @if ($new_sensor_image!=null)
                                    <img src="{{$new_sensor_image->temporaryUrl()}}" width="120"/>
                                    @else
                                    <img src="{{ asset('sensors/sensorsimages') }}/{{ $sensor_image }}"  width="120"/>
